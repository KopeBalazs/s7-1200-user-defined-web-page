...
function createMonitorElementByType(monitorElementType) {
  getPLCData("TagResources/ID.htm", createMonitorElementByTypeAndId, monitorElementType);
  ...
  function createMonitorElementByTypeAndId(freeId, monitorElementType) {
    ...
    if (freeId != 0) {
      ...
      //Reserve the free element of the Elements array by setting its id to the freeid
      postPLCData("TagResources/elements.htm", '"WebDB".Elements['+freeId+'].elementID=' + freeId + ', "WebDB".test1=13');
      ...
      //Create a new monitor element struct, save the container div and its attributes in it, then add it to the monitorElementAdapter array
      //monitorElementAdapters.push(new monitorElementAdapter(monitorElementType, monitorElementContainerDiv));
